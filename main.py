...
class Agent():
    ...
    def learn(self, experiences, discount_factor):
        ...
        next_q_states = self.target_qnetwork(next_states).detach().max(1)[0].unsqueeze(1)
        q_targets = rewards + discount_factor * next_q_states * (1 - dones)
